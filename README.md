ENTER YOUR NAME: Indhu Priya T
ENTER YOUR REGISTER NO:212224110024
EX. NO.4
DATE:
...
• Function signal of jth neuron is image image image

If jth neuron is output neuron, the m=mL and output of j th neuron is image

Forward phase begins with in the first hidden layer and end by computing ej(n) in the output layer image
